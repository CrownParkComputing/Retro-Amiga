...
// Returns the joystick device index of the on-screen CD32 pad, or -1 if not registered
extern int get_onscreen_cd32pad_device_index();

// Register the on-screen CD32 pad device if not already present.
extern void ensure_onscreen_cd32pad_registered();
