...
void gui_display(int shortcut)
{
	...
	// Drain any mouse events generated by re-enabling grabs / relative mode.
	// The clickthrough hint (reset in amiberry_gui_halt) only helps windowed
