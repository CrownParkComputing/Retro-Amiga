...
bool my_utime(const char* name, const struct mytimeval* tv)
{
	...
	try {
		...
		// Cast rather than brace-initialise: mtv is 64-bit, while tv_sec and
		// tv_usec are long on 32-bit targets (armeabi-v7a, i386), where a
		// braced initialiser is a narrowing conversion and ill-formed.
