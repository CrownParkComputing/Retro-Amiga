...
/// Shift/Ctrl/Alt/Amiga are plain keys too -- held as long as the finger is.
class AmigaKeyboardOverlay extends StatelessWidget {
                  ...
                  for (final _KeySpec spec in row)
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: _Key(spec: spec, onKey: onKey),
                      ),
                    ),
                ],
              ),
...
class _Key extends StatefulWidget {
  const _Key({required this.spec, required this.onKey});
...
class _KeyState extends State<_Key> {
  ...
  void _set(bool pressed) {
    ...
    if (code != null) widget.onKey(code, pressed);
  }
