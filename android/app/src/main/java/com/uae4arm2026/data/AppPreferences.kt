...
class AppPreferences private constructor(context: Context) {
	...
	private val prefs: SharedPreferences =
		AppStorage.openPreferences(context)

	var useDynamicColor = mutableStateOf(prefs.getBoolean(KEY_DYNAMIC_COLOR, false))
		private set
	...
	fun setHasCompletedSetup(done: Boolean) {
		hasCompletedSetup.value = done
