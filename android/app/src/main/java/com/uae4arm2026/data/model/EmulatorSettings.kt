...
data class EmulatorSettings(
	...
	val useRtg: Boolean = false,  // Enable RTG (uaegfx, 8 MB Z3)
	...
	val soundStereoSeparation: Int = 7,
	val soundInterpolation: String = "anti",
	...
	companion object {
		...
		val soundInterpolationOptions = listOf(
			"none" to "None",
			"anti" to "Anti",
			"sinc" to "Sinc",
			"rh" to "RH",
